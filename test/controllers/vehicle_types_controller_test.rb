...
class VehicleTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vehicle_type" do
    assert_difference('VehicleType.count') do
      post vehicle_types_url, params: { vehicle_type: { description: @vehicle_type.description, name: @vehicle_type.name, status: @vehicle_type.status, uid: @vehicle_type.uid, user_id: @vehicle_type.user_id } }
    end
  ...
  test "should update vehicle_type" do
    patch vehicle_type_url(@vehicle_type), params: { vehicle_type: { description: @vehicle_type.description, name: @vehicle_type.name, status: @vehicle_type.status, uid: @vehicle_type.uid, user_id: @vehicle_type.user_id } }
