...
class VehicleModelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vehicle_model" do
    assert_difference('VehicleModel.count') do
      post vehicle_models_url, params: { vehicle_model: { manufacturer: @vehicle_model.manufacturer, name: @vehicle_model.name, status: @vehicle_model.status, uid: @vehicle_model.uid, user_id: @vehicle_model.user_id, vehicle_type_id: @vehicle_model.vehicle_type_id } }
    end
  ...
  test "should update vehicle_model" do
    patch vehicle_model_url(@vehicle_model), params: { vehicle_model: { manufacturer: @vehicle_model.manufacturer, name: @vehicle_model.name, status: @vehicle_model.status, uid: @vehicle_model.uid, user_id: @vehicle_model.user_id, vehicle_type_id: @vehicle_model.vehicle_type_id } }
